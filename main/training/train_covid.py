"""
Train COVID-19 Model (3-class: covid, normal, viral_pneumonia)
...
MODEL_NAME = "covid"
DATASET_DIR = os.path.join(DATASETS_DIR, "covid_radiography")
...
def main():
    ...
    # COVID dataset is imbalanced (normal >> covid >> viral_pneumonia)
    result = train_model(
        model=model,
